...
without necessarily having a billing card.`
    ...
    // an user has many fact checks as checker 
    factChecksAsChecker: {
      collection: 'factcheck',
      via: 'checker',
    },

    // an user has many fact checks as moderator
    factChecksAsModerator: {
      collection: 'factcheck',
      via: 'moderator',
    },

    // a moderator has many events
    events: {
      collection: 'event',
      via: 'moderators',
    },

    // a politician belongs to a party
    party: {
      model: 'party'
    },
